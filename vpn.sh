...
wget -O /etc/openvpn/easy-rsa/vars "https://raw.githubusercontent.com/izinrecode/AutoScriptSSH/main/vars.conf"
...
# install openvpn
wget -O /etc/openvpn/vpn.zip "https://github.com/izinrecode/AutoScriptSSH/raw/main/vpn.zip"
cd /etc/openvpn/
unzip vpn.zip
rm -f vpn.zip
cd
